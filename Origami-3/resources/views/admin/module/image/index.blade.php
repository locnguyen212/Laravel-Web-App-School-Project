                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>                                                                     
                                ...
                                <td> <img src=" {{ file_exists('images/'.$data->image)? asset('images/'.$data->image) : $data->image }} " height="50px" width="50px"> </td> 

                                <td> {{ $data->image }} </td>
                                
                                <td> <a href="{{ route('admin.image.edit', ['id' => $data->id]) }}">Edit</a> </td>
                                
                                <td><a href="{{ route('admin.image.destroy', ['id' => $data->id]) }}" onclick="return acceptDelete()">Delete</a></td>                               
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
